    ...
    <app-layout title="refills">
        ...
        <container>
            <div class="flex justify-between">
                <jet-button :href="route('refills.create')"
            ...
            <card>
                <data-table :headers="headers" :items="refills">
                    <tr v-for="refill in refills.data" :key="refill.id">
                        <td class="px-6 py-4 whitespace-nowrap">
                            {{ refill.clients.business }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            {{ refill.payment }}
                        </td>
...
export default {
    ...
    computed: {
        headers() {
            return ["Empresa", "Pago", "Banco", "Fecha", "Total", "Acciones"];
        },
    },
};
</script>
