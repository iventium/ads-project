                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div>
                        ...
                        >
                            ...
                            <div
                                class="p-6 border-t border-gray-200 col-span-2"
                            >
                                <div class="flex justify-center items-center">
                                    ...
                                    <div
                                        class="ml-4 text-2xl text-gray-600 leading-7 font-semibold"
                                    >
                                ...
                                <div class="w-full text-center">
                                    <h3
                                        class="mt-2 text-6xl font-semibold text-emerald-400"
                                    >
                                        $
...
export default {
    ...
    setup(props) {
        const handleBalance = computed(() => {
            ...
            clients.map((client) => {
                arrayBalance.push(+client.balance);
            });
